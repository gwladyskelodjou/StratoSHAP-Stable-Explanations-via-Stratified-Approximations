...
class StratoSHAP(ShapleyEstimator):
    """StratoSHAP method to compute feature importances of any trained model."""
    ...
    def approximate_shapley_values(self):
        ...
        stratum = utils.budget_to_stratum(self.budget-2, self.n)
        self.stratum = max(1, stratum)
        final_budget = utils.stratum_instance_number(self.stratum, self.n)+2
        ...
        coalitions = utils.stratum_coalitions(self.stratum, self.n)
    ...
    def get_estimates(self):
        """
        Returns the estimated Shapley values.
        """
